...
class SupplyDetail2 extends StatefulWidget {
  final Product product;

  SupplyDetail2({super.key, required this.product});

  @override
  State<SupplyDetail2> createState() => _SupplyDetail1State();
}

class _SupplyDetail1State extends State<SupplyDetail2> {
