...
class SupplyDetail1 extends StatefulWidget {
  final Product product;

  SupplyDetail1({super.key, required this.product});

  @override
  State<SupplyDetail1> createState() => _SupplyDetail1State();
}

class _SupplyDetail1State extends State<SupplyDetail1> {
